...
class AdminUsersController extends Controller
{
    ...
    public function exportExcel(Request $request)
    {
        ...
        $users = User::orderBy('id', 'desc')->limit(500)->get();
    ...
    public function getTestimony(User $participant)
    {
        return response()->json([
    ...
    public function updateTestimony(Request $request, User $participant)
    {
        $data = $request->all();
        $success = $participant->update([
