...
class CertificationService
{
    public function getParticipantsTable(Request $request, Event $event)
    {
        $query = $event->certifications()
            ...
            ->with(['user.company', 'event.courseModule'])
        ...
        $allCertifications = DataTables::of($query)
            ...
            ->addColumn('action', function ($certification) {
                ...
                if (
                    ...
                    // $isSpec = $certification->event->courseModule->count() != 0 ? 'specCourse' : '';
                    $isSpec = $certification->event->courseModule ? 'specCourse' : '';

                    $btn .= '<a href="javascript:void(0)" data-id="' .
                        $certification->id . '" data-original-title="delete" data-spec="'. $isSpec .'"
