            ...
            ->addColumn('action', function ($user) {
                ...
                if ($user->role == 'participants') {
                    ...
                    $btn .= '<button data-toggle="modal" data-id="' .
                        $user->id . '" data-url="' . route('admin.participant.updateTestimony', $user) . '"
                                data-send="' . route('admin.participant.getTestimony', $user) . '"
                                data-original-title="edit" class="me-3 edit btn btn-info btn-sm
                                btnTestimony"><i class="fa-solid fa-bookmark"></i></button>';
                }
