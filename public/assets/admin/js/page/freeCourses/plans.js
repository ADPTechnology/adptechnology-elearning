...
$(() => {
    ...
    if ($("#plans-free-courses-table").length) {
        let plansDataTableEle = $("#plans-free-courses-table");
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            if (data.success) {
                                ...
                                $("#container-select-plan").html(
                                    data.htmlSelectPlan
                                );

                                InitSelect2(
                                    "#fc-register-participants-form .select_plan_course",
                                    {
                                        closeOnSelect: true,
                                    }
                                );
