    ...
    <div class="row content">
        ...
        <div class="main-container-page">
            ...
            <div class="card-body card z-index-2 principal-container">
                ...
                <table id="history-table" class="table table-hover" data-url="{{ route('admin.purchaseHistory.index') }}">
                    <thead>
                        <tr>
                            <th>N°</th>
                            <th>Participante</th>
...
@section('extra-script')
    <script type="module" src="{{ asset('assets/admin/js/historyAdmin.js') }}"></script>
@endsection
