        ...
        <div class="modal-content">
            ...
            <form action="" id="registerChapterForm" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            <label for="input-file-chapter">Video *</label>
                            <div class="input-group">
                                <input type="file" id="input-file-chapter" class="input-chapter-video" name="file"
                                    style="display: none;">
                                <label for="input-file-chapter" id="label-input-file-chapter"
