                    ...
                    <div class="principal-inner-container total-width">
                        ...
                        <div class="inner-title-container">
                            ...
                            <div class="related-dropdown-container table-container" style="display: none;">
                                ...
                                <div>
                                    <div>
                                        <h6>Lista de Planes</h6>
                                    </div>

                                    <div class="table-border-style">

                                        <div class="table-responsive">
                                            <table id="plans-free-courses-table" class="table table-hover"
                                                data-url='{{ route('admin.plans.index', $course) }}'>
                                                <thead>
                                                    <tr>
                                                        <th>N°</th>
                                                        <th>Titulo</th>
...
@section('modals')
    ...
    {{-- ADD PLANS --}}
    @include('admin.free-courses.plans.partials.modals._add_plans')
    @include('admin.free-courses.plans.partials.modals._edit')
@endsection
...
@section('extra-script')
    ...
    <script type="module" src="{{ asset('assets/admin/js/page/freeCourses/plans.js') }}"></script>
@endsection
