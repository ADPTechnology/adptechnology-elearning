        ...
        <div class="main-container-page">
            ...
            <div class="card-body card z-index-2 principal-container">
                ...
                <div class="principal-splitted-container mt-1 mb-2">
                    <div class="principal-inner-container total-width">
                        <div class="inner-title-container">
                            <div id="" class="btn-dropdown-container">
                                <h5 class="title-header-show">
                                    <i class="fa-solid fa-image not-rotate"></i>
                                    &nbsp;
                                    Fondo
                                </h5>
                            ...
                            <div id="background-list-container" class="related-dropdown-container" style="display: none;">
                                @include('admin.settings.partials.components._background')
                            </div>
                ...
                <div class="principal-splitted-container mt-1 mb-2">
                    ...
                    <div class="principal-inner-container total-width">
                        ...
                        <div class="inner-title-container">
                            <div id="" class="btn-dropdown-container">
                                <h5 class="title-header-show">
                                    <i class="fa-solid fa-magnifying-glass-chart not-rotate"></i>
                                    &nbsp;
                                    Datos del sistema
                                </h5>
                        ...
                        <div id="group-list-container" class="related-dropdown-container" style="display: none;">
                            <form action="{{ route('admin.settings.config.group.update', $config) }}" id="editGroupForm"
                                method="POST">

                                @include('admin.settings.partials._group')
                ...
                <div class="card page-title-container">
                    <div class="card-header">
                        <div class="total-width-container">
                            <h4> Configuración de Páginas de reglamentos</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="principal-splitted-container mt-1 mb-2">
                    ...
                    <div class="principal-inner-container total-width">
                        ...
                        <div class="inner-title-container">
                            <div id="" class="btn-dropdown-container">
                                <h5 class="title-header-show">
                                    <i class="fa-solid fa-file-lines not-rotate"></i> &nbsp;
                        ...
                        <div id="config-list-container" class="related-dropdown-container" style="display: none;">
                            <form action="{{ route('admin.settings.config.update.privacy', $config) }}"
                                id="editPrivacyPoliciesForm" method="POST" enctype="multipart/form-data">

                                @include('admin.documentation.partials._form_privacy-policies')
                ...
                <div class="principal-splitted-container mt-1 mb-2">
                    ...
                    <div class="principal-inner-container total-width">
                        ...
                        <div id="config-list-container" class="related-dropdown-container" style="display: none;">
                            <form action="{{ route('admin.settings.config.update.terms', $config) }}"
                                id="editTermsConditionsForm" method="POST" enctype="multipart/form-data">

                                @include('admin.documentation.partials._form_terms-conditions')
                ...
                <div class="principal-splitted-container mt-1 mb-2">
                    ...
                    <div class="principal-inner-container total-width">
                        ...
                        <div id="config-list-container" class="related-dropdown-container" style="display: none;">
                            <form action="{{ route('admin.settings.config.update.data', $config) }}"
                                id="editDataDeletionForm" method="POST" enctype="multipart/form-data">

                                @include('admin.documentation.partials._form_data-deletion')
...
@section('modals')
    ...
    {{-- * FONDO --}}
    @include('admin.settings.partials.modals._background_store')
