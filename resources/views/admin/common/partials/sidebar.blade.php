<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            {{-- <li class="{{ setActive('admin.advertisements.*') }}">
            ...
            {{-- <li class="{{ setActive('admin.plans.*') }}">
                <a href="{{ route('admin.plans.index') }}" class="nav-link">
                    <i class="fa-solid fa-coins"></i>
                    <span>Planes</span>
                </a>
            </li> --}}
            <li class="{{ setActive('admin.subscriptions.*') }}">
                <a href="{{ route('admin.subscriptions.index') }}" class="nav-link">
                    <i class="fa-duotone fa-solid fa-key"></i>
                    <span>Suscripciones</span>
                </a>
            </li>
            <li class="{{ setActive('admin.purchaseHistory.*') }}">
                <a href="{{ route('admin.purchaseHistory.index') }}" class="nav-link">
