<div class="modal-body">
    ...
    <div class="form-row">
        <div class="form-group col-md-12">
            <label>Texto *</label>
            <input type="text" name="text" class="form-control" placeholder="Escriba el texto">
        </div>
    </div>
            ...
            <div>
                <div id="image-preview" class="image-preview">
                    ...
                    <input type="file" name="image"
                        id="{{ $state === 'edit' ? 'input-advertising-image-edit' : 'input-advertising-image-register' }}">
    ...
    <div class="form-group">
        ...
        <div class="selectgroup selectgroup-pills">
            <label class="selectgroup-item">
                <input type="radio" name="generation_type" value="AUTOMATIC" class="selectgroup-input gen_type_radio"
                    checked>
