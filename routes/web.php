...
use App\Http\Controllers\Home\{HomeAboutController, HomeController, HomeCourseController, HomeCertificationController, HomeCheckoutPaymentController, HomeFreeCourseController, HomeShoppingCartController, HomeWebinarController, TermsAndConditionsController};
...
// Facebook
// Route::get('auth/facebook', [LoginController::class, 'redirectToFacebook'])->name('auth.facebook.redirect');
...
Route::controller(HomeController::class)->group(function () {
    ...
    Route::get('/informacion-del-curso/{course}', 'information')->name('home.information.course');
...
Route::group(['prefix' => '/', 'as' => 'page.'], function () {

    Route::controller(TermsAndConditionsController::class)->group(function () {
        Route::get('/politica-y-privacidad', 'privacyPolicies')->name('privacy-policies');
        Route::get('/terminos-y-condiciones', 'termsConditions')->name('terms-conditions');
        Route::get('/eliminacion-de-datos', 'dataDeletion')->name('data-deletion');
        Route::get('/libro-de-reclamaciones', 'complaintsBook')->name('complaints-book');
        Route::post('/enviar-email-sobre-reclamo', 'sendBookEmail')->name('send-book');
    });
});
...
Route::controller(LoginController::class)->group(function () {
    ...
    // Route::get('/olvidaste-contrasena', 'resetPassword')->name('resetPassword');
    Route::post('/login/validate-attempt', 'validateAttempt')->name('login.validateAttempt');
...
Route::controller(RegisterController::class)->group(function () {
    ...
    Route::get('/registro/validate-email', 'validateEmail')->name('register.validateEmail');
...
Route::controller(HomeFreeCourseController::class)->group(function () {
    ...
    Route::get('/cursos', 'index')->name('home.freecourses.categories.index');
...
Route::controller(HomeAboutController::class)->group(function () {
    ...
    Route::get('/contactanos', 'contactUs')->name('home.about.contact');
    Route::post('/envio-de-correo-contacto', 'sendEmailContact')->name('home.about.contact.sendEmail');
});

Route::controller(HomeShoppingCartController::class)->group(function () {

    Route::get('obtener-items/{course}', 'index')->name('home.cart.index');
    Route::get('obtener-items-libre/', 'free')->name('home.cart.index.free');
    Route::get('/eliminar-cupon-descuento/', 'deleteCoupon')->name('home.cart.order.coupon.destroy');
    Route::post('/registrar-en-carrito/{plan}', 'store')->name('home.cart.store');
    Route::post('/aplicar-cupon-descuento/', 'applyCoupon')->name('home.cart.order.coupon');

    Route::delete('/eliminar-de-carrito/{shoppingCart}/{course}', 'destroy')->name('home.cart.destroy');
    Route::delete('/eliminar-de-carrito-libre/{shoppingCart}', 'destroyFree')->name('home.cart.destroy.free');
    Route::delete('/eliminar-del-carrito/no-session/{plan}', 'destroySession')->name('home.cart.destroy.session');
});

Route::controller(HomeCheckoutPaymentController::class)->group(function () {

    Route::get('/payment/obtener-plan/{plan}', 'getPlan')->name('home.payment.get');
    Route::get('/eliminar-coupon/', 'deleteCoupon')->name('home.payment.coupon.destroy');
    Route::get('/obtener-oferta/{advertising}/{couponCode}', 'getAdvertising')->name('home.payment.getAdvertising');
    Route::get('/payment/checkout/{couponCode?}', 'checkout')->name('home.payment.checkout');
    Route::get('/view-payment-completed/{order}', 'viewPayment')->name('home.payment.view');
    Route::post('/payment-verify-user/', 'verifyUser')->name('home.payment.verifyUser');
    Route::post('/paid-completed', 'paid')->name('home.payment.completed');
});
        ...
        Route::group(['middleware' => 'check.role:admin,super_admin'], function () {
            ...
            Route::group(['prefix' => 'configuraciones', 'as' => 'settings.'], function () {
                ...
                Route::controller(SettingsController::class)->group(function () {
                    ...
                    Route::get('/', 'index')->name('index');
                    Route::post('/actualizar-configuracion/{config}', 'updateConfig')->name('config.update');
                    Route::post('/actualizar-politica-privacidad/{config}', 'updatePrivacy')->name('config.update.privacy');
                    Route::post('/actualizar-terminos-condiciones/{config}', 'updateTerms')->name('config.update.terms');
                    Route::post('/actualizar-eliminacion-datos/{config}', 'updateData')->name('config.update.data');
                    Route::post('/actualizar-configuracion-de-grupos/{config}', 'updateGroup')->name('config.group.update');
                    Route::post('/actualizar-logo/{config}', 'updateLogo')->name('config.update.logo');
                    Route::post('/actualizar-fondo/{config}', 'updateBackground')->name('config.update.background');
                    Route::delete('/eliminar-logo/{config}', 'destroyLogo')->name('config.destroy.logo');
                    Route::delete('/eliminar-fondo/{config}', 'destroyBackground')->name('config.destroy.background');
                });
            ...
            Route::group(['prefix' => 'usuarios'], function () {
                ...
                Route::controller(AdminUsersController::class)->group(function () {
                    ...
                    Route::get('/obtener-testimonio/{participant}', 'getTestimony')->name('participant.getTestimony');
                    ...
                    Route::post('/actualizar-testimonio/{participant}', 'updateTestimony')->name('participant.updateTestimony');
            ...
            Route::group(['prefix' => 'historial-compras', 'as' => 'purchaseHistory.'], function () {

                Route::controller(AdminPurchaseHistoryController::class)->group(function () {
                    Route::get('/', 'index')->name('index');
                    Route::get('ver-orden-de-compra/{order}', 'show')->name('show');
                });
            });
            ...
            Route::group(['prefix' => 'publicidades', 'as' => 'advertisements.'], function () {

                Route::controller(AdminAdvertisingController::class)->group(function () {

                    Route::get('/', 'index')->name('index');
                    Route::get('/crear', 'create')->name('create');
                    Route::get('/editar/{advertising}', 'edit')->name('edit');
                    Route::post('/registrar', 'store')->name('store');
                    Route::post('/actualizar/{advertising}', 'update')->name('update');
                    Route::delete('/eliminar/{advertising}', 'destroy')->name('destroy');
                });
            });
            ...
            Route::group(['prefix' => 'cupones', 'as' => 'coupons.'], function () {

                Route::controller(AdminCouponController::class)->group(function () {

                    Route::get('/', 'index')->name('index');
                    Route::get('/crear', 'create')->name('create');
                    Route::get('/editar/{coupon}', 'edit')->name('edit');

                    Route::post('/registrar', 'store')->name('store');
                    Route::post('/actualizar/{coupon}', 'update')->name('update');

                    Route::delete('/eliminar/{coupon}', 'destroy')->name('destroy');
                });
            });

            // --------------- FREE COURSES -----------------

            Route::group(['prefix' => 'cursos', 'as' => 'freeCourses.'], function () {
            ...
            Route::group(['prefix' => 'planes', 'as' => 'plans.'], function () {
                Route::controller(AdminPlanController::class)->group(function () {
                    Route::get('/obtener/{course}', 'index')->name('index');
                    // Route::get('/crear', 'create')->name('create');
                    Route::get('/editar/{plan}', 'edit')->name('edit');
                    Route::post('/registrar/{course}', 'store')->name('store');
                    Route::post('/actualizar/{plan}', 'update')->name('update');
                    Route::delete('/eliminar/{plan}', 'destroy')->name('destroy');
                });
            });

            Route::group(['prefix' => 'subscriptions', 'as' => 'subscriptions.'], function () {
                Route::controller(AdminSubscriptionsController::class)->group(function () {
                    Route::get('/', 'index')->name('index');
                    Route::get('/crear', 'create')->name('create');
                    Route::get('/obtener-usuarios', 'getUsersList')->name('getUsersList');
                    Route::post('/registrar', 'store')->name('store');
                    Route::delete('/eliminar/{subscription}', 'destroy')->name('destroy');
                });
            });
    ...
    Route::group(['middleware' => 'aula', 'prefix' => 'aula', 'as' => 'aula.'], function () {
        ...
        Route::group([
            ...
            Route::group(['middleware' => 'check.role:participants'], function () {
                ...
                Route::group(['prefix' => 'cursos', 'as' => 'freecourse.'], function () {
                    ...
                    Route::controller(AulaFreeCourseController::class)->group(function () {
                        ...
                        Route::get('/consultar-analisis-financiero/', 'finance')->name('finance');
                        Route::get('/descargar-archivo/{file}', 'downloadFile')->name('files.download');
                        Route::post('/analisis-financiero/', 'showFinance')->name('showFinance');
                ...
                Route::group(['prefix' => 'historial-compras', 'as' => 'purchaseHistory.'], function () {
                    ...
                    Route::controller(AulaPurchaseHistoryController::class)->group(function () {
                        Route::get('/', 'index')->name('index');
                        Route::get('ver-orden-de-compra/{order}', 'show')->name('show');
                        // Route::get('/categoria/{category}', 'showCategory')->name('showCategory');
                        // Route::get('/curso/{course}/{current_chapter}', 'showChapter')->name('showChapter');
